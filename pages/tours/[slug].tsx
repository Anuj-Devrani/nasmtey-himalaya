...
import { IDhamFields } from '../../@types/contentful'
...
export const getStaticProps = async (ctx) => {
  ...
  const tour = await ContentService.instance.getTourBySlug(slug)
...
export const getStaticPaths: GetStaticPaths = async () => {
  const tours = await ContentService.instance.getEntriesByType<IDhamFields>(
    'dham'
  )

  return {
    paths: tours.map((trek) => ({
      params: {
        slug: trek.fields.dhamId,
      },
    })),
    fallback: false,
  }
        ...
        <div className="mt-28 w-full max-w-7xl justify-center p-4">
          ...
          <div className="mt-4 flex flex-col md:flex-row">
            <div className="basis-2/3">
              <ImageGallery imagesSet={carouselImages} />
